...
func (api *APIImpl) CallManyBundle(ctx context.Context, bundles []BundleSimulate, simulateContext StateContext, stateOverride *ethapi.StateOverrides, timeoutMilliSecondsPtr *int64) ([][]map[string]interface{}, error) {
	var (
		hash               common.Hash
